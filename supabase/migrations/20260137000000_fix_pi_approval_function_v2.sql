-- =============================================================================
-- Migration: Fix create_invoice_from_pi_approval function (v2)
-- =============================================================================
-- Fixes:
-- 1. Use JSONB milestones from payment_terms_templates (not separate table)
-- 2. Use correct table name: invoice_payment_schedule_items
-- 3. Use correct column names: trigger (not milestone_trigger)
-- =============================================================================
