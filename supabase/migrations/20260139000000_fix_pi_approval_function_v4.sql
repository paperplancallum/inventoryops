-- =============================================================================
-- Migration: Fix create_invoice_from_pi_approval function (v4)
-- =============================================================================
-- Fixes:
-- 1. Add explicit casts for enum types in CASE statements
-- =============================================================================
...
BEGIN
  ...
  IF v_milestones IS NOT NULL AND jsonb_array_length(v_milestones) > 0 THEN
    ...
    LOOP
      ...
      INSERT INTO invoice_payment_schedule_items (
        ...
        v_sort,
        -- Explicit cast to payment_trigger_status enum
        (CASE
  ...
  ELSE
    ...
    INSERT INTO invoice_payment_schedule_items (
      ...
      100,
      COALESCE(v_po.total, 0),
      'po_confirmed'::payment_milestone_trigger,
      'triggered'::payment_trigger_status,
      NOW(),
      v_today,
      1
    );
