...
import type { ProductSKU, SKUCondition } from './types'
  ...
  return (
    <div className="overflow-x-auto">
      ...
      <DeleteConfirmModal
        ...
        onConfirm={() => {
          if (skuToDelete && onDeleteSKU) {
            onDeleteSKU(skuToDelete.id)
          }
        }}
        title="Delete SKU Variant"
        message="Are you sure you want to delete this SKU variant? This will remove all associated stock and tracking data."
        itemName={skuToDelete?.sku}
        confirmLabel="Delete"
