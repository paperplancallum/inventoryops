import type { InboxRowProps } from './types'
...
const UndoIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function InboxRow({
  ...
  // Row background based on read status and cleared status
  const rowBgClass = message.isCleared
