...
// =============================================================================
// Shipping Agent Types (for inbox aggregation)
// =============================================================================
...
export interface InboxViewProps {
  /** All messages aggregated from POs and Shipping Agents */
  messages: InboxMessage[]
  /** Summary statistics */
  summary: InboxSummary
  /** Available suppliers for filtering */
  suppliers: Supplier[]
  /** Available shipping agents for filtering */
  ...
  /** Called when user restores a cleared message */
...
export type InboxSourceFilter = 'all' | InboxSourceType
export type InboxMessageTypeFilter = 'all' | 'inbound' | 'outbound' | 'note'
