...
import type { ReplenishmentSuggestion, ShippingRoute, ReasoningItem } from '../types'
...
function extractWarehouseName(routeName: string | null | undefined): string {
