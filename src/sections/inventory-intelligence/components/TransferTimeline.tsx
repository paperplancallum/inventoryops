...
import type { TransferTimelineProps, ShippingMethod } from '../types'
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col items-center w-1/4">
              ...
              {suggestion.routeMethod && (
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  via {methodLabels[suggestion.routeMethod as ShippingMethod] || suggestion.routeMethod}
                </p>
              )}
            </div>
        ...
        <div className="sm:hidden space-y-3">
          ...
          <div className="flex items-center gap-3 ml-4 border-l-2 border-slate-200 pl-4 dark:border-slate-700">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-slate-900 dark:text-white">
                {transitDays} day{transitDays !== 1 ? 's' : ''} via {methodLabels[(suggestion.routeMethod || 'ground') as ShippingMethod] || 'Ground'}
              </p>
            </div>
          </div>
