...
export function DocumentsView({
  ...
  // Use client-side filtering for immediate responsiveness
  // Server-side filtering via onFilterChange is available for large datasets if needed
      ...
      <div className="bg-white dark:bg-stone-900 rounded-lg border border-stone-200 dark:border-stone-700 overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4">
            ...
            <p className="text-stone-500 dark:text-stone-400">Loading documents...</p>
          </div>
